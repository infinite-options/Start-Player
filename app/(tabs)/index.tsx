...
// export default function DixitSelector() {
...
//       <Image
//         source={require('../../assets/images/dixit-logo.png')}
//         style={styles.logo}
//       />
...
import React, { useState, useRef } from 'react';
import { View, Text, Image, StyleSheet, PanResponder, ImageBackground } from 'react-native';
import Animated, { useSharedValue, useAnimatedStyle } from 'react-native-reanimated';
    ...
    <View style={styles.container}> 
      ...
      <View style={styles.circleContainer}>
        ...
        >
          ...
          <ImageBackground
            source={require('../../assets/images/dixit-background.jpg')}
